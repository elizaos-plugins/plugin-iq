 ...
 * IQ Plugin
 *
 * On-chain chat connector for Solana via IQLabs.
 * Connects to all configured chatrooms simultaneously.
...
const iqPlugin: Plugin = {
  ...
  init: async (_config: Record<string, string>, runtime: IAgentRuntime) => {
    ...
    if (!hasKeypair) {
      ...
      logger.warn("Set SOLANA_PRIVATE_KEY in your .env file to enable full functionality");
    }
  },
};
